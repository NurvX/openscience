  ...
  const actions: Record<ArtifactKind, Array<Omit<ArtifactAction, "prompt"> & { instruction: string }>> = {
    notebook: [
      ...
      },
      {
        ...
        description: "Check methods, leakage, statistics, and conclusions.",
        instruction:
          "Review this notebook as a scientific reviewer. Check methods, data leakage, statistics, and claims.",
      },
      {
        id: "export-notebook",
