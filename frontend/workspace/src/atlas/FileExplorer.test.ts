...
describe("file explorer surface", () => {
  test("organizes Files around sources instead of a host filesystem root", () => {
    ...
    expect(value).toContain('title="Session files"')
    expect(value).toContain('title="Project folder"')
    expect(value).toContain('detail="Already connected"')
    ...
    expect(value).toContain('detail="Writable workspace"')
