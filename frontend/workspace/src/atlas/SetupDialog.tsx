      ...
      >
        ...
        <Show when={view() === "choose"}>
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "8px" }}>
            <ChoiceCard
              ...
              hint="recommended"
              body="Sign in to Synthetic Sciences for managed models, credits, and synced services."
              onClick={openManaged}
            />
            <ChoiceCard
              title="ChatGPT / Codex"
        ...
        <Show when={view() === "managed"}>
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "6px" }}>
            <span style={label()}>Synthetic Sciences API key</span>
            <TextField
              type="password"
              hideLabel
              placeholder="thk_…"
        ...
        <Show when={view() === "done"}>
          <p style={intro()}>
            Connected to Synthetic Sciences.
