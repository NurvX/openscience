...
describe("desktop onboarding", () => {
  ...
  test("fails closed until every managed-access capability is known", () => {
    ...
    expect(canUseManaged({ signedIn: true, managedSupported: true, aceEnabled: false, balanceUsd: 20 })).toBe(false)
